...
public class AuditableGiftCertificateTest {
    ...
    public AuditableGiftCertificateTest() { }

    public AuditableGiftCertificateTest(long id, long entityId, String operationType, ZonedDateTime operationTimeStamp) {
        this.id = id;
