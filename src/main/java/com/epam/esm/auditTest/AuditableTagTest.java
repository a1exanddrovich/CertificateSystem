...
public class AuditableTagTest {
    ...
    public AuditableTagTest() { }

    public AuditableTagTest(long id, long entityId, String operationType, ZonedDateTime operationTimeStamp) {
        this.id = id;
