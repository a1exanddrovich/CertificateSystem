...
public class TagsController {
     ...
     * @throws {@link BadEntityException} in case if invalid data passed in request to create an {@link Tag} object.
     * @throws {@link EntityAlreadyExistsException} in case if passed tag already exists in database.
     * @throws {@link EntityNotExistsException} in case if nothing found with searched id.
     */
